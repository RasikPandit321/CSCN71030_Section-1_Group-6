...
void PrintReceipt(Bill bill) {
    ...
    // Declare file pointer and errno_t variable
    FILE* file = NULL;
    errno_t err;

    // Use fopen_s() correctly
    err = fopen_s(&file, "C:\\Users\\DELL\\OneDrive - University of Guelph\\Desktop\\Conestoga\\Winter 25\\05 - Project II\\Billing Module\\Billing_Module_Tests\\receipt.txt", "w");
    ...
    if (err == 0 && file != NULL) {
        ...
        printf("Error saving receipt to file. Error Code: %d\n", err);
    }
}
